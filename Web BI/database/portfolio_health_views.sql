...
-- 
-- FIXES APPLIED:
-- - All column names use quoted format ("property id" instead of property_id)
...
FROM occupancy_score os, financial_score fs, credit_score cs, leasing_score ls;
...
WITH data_completeness AS (
    SELECT 
        ...
        COUNT(CASE WHEN leased_area IS NULL OR leased_area = 0 THEN 1 END) * 100.0 / 
